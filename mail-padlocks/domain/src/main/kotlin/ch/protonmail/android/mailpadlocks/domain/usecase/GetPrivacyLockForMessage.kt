...
class GetPrivacyLockForMessage @Inject constructor(
    private val privacyLockRepository: PrivacyLockRepository
) {

    suspend operator fun invoke(userId: UserId, messageId: MessageId): Either<DataError, PrivacyLock> =
        privacyLockRepository.getPrivacyLock(userId, messageId)
}
