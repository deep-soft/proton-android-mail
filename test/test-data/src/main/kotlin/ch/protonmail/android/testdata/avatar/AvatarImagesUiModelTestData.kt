...
object AvatarImagesUiModelTestData {

    private val mockFile = File("mockImage1.png")

    val SampleData1 = AvatarImagesUiModel(
        states = mapOf(
            "user1@example.com" to AvatarImageUiModel.Data(mockFile),
            "user2@example.com" to AvatarImageUiModel.Loading,
            "user3@example.com" to AvatarImageUiModel.NoImageAvailable
        )
    )
}
