...
class SaveMessageBodyWebViewCrash @Inject constructor(
    private val crashRecordRepository: CrashRecordRepository
) {

    suspend operator fun invoke() = crashRecordRepository.save(MessageBodyWebViewCrash(hasCrashed = true))
}
