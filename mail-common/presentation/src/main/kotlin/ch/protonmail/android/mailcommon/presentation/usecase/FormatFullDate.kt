...
class FormatFullDate @Inject constructor(
    private val getAppLocale: GetAppLocale
) {

    operator fun invoke(instant: Instant): String = DateFormat
        .getDateTimeInstance(DateFormat.LONG, DateFormat.MEDIUM, getAppLocale())
