...
class EphemeralMailboxCursorRepositoryTest {
    ...
    private val sut = EphemeralMailboxCursorRepository(CoroutineScope(mainDispatcherRule.testDispatcher))
    private val testCursorId = CursorId(ConversationId("test Id"))
    private val createCursor = suspend {
