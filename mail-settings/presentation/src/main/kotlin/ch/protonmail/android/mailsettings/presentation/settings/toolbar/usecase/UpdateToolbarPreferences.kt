...
@ViewModelScoped
class UpdateToolbarPreferences @Inject constructor(
    ...
    suspend operator fun invoke(
        userId: UserId,
        type: ToolbarType,
        actions: ToolbarActionsPreference
    ): Either<DataError, Unit> {

        val selectedActions = actions.actionsList.current.selected
        return toolbarActionsRepository.saveActions(userId, type, selectedActions)
    }
}
