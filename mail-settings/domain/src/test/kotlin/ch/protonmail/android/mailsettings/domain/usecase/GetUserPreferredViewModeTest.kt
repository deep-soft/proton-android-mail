...
class GetUserPreferredViewModeTest {
    ...
    @Test
    fun `returns view mode from mail settings when success`() = runTest {
        // Given
        ...
        // When
        val actual = getUserPreferredViewMode(userId)
    ...
    @Test
    fun `returns default view mode when mail settings contain no valid view mode info`() = runTest {
        // Given
        val userId = UserIdSample.Primary
        val expected = ViewMode.NoConversationGrouping
