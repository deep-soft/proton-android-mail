...
interface InMemoryToolbarActionsRepository {

    fun inMemoryPreferences(type: ToolbarType): Flow<Either<Error, ToolbarActionsPreference>>

    fun toggleSelection(action: Action, toggled: Boolean)
    ...
    sealed interface Error {
        ...
        data object InvalidActions : Error
    }
}
