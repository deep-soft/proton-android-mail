...
class SubmitIssueReport @Inject constructor(
    private val reportRepository: BugReportRepository
) {

    suspend operator fun invoke(userId: UserId, report: IssueReport) = reportRepository.submitBugReport(userId, report)
}
