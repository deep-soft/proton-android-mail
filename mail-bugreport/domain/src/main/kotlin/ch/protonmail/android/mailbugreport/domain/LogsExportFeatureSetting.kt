 ...
 *
 * @param enabled Logs application events to a file in the internal app storage (cache)
 * during the application lifecycle.
 *
 * @param internalEnabled Enables the intermediate "Application logs" screen and also allows exporting logcat data
 * from the device in use. This is enabled and available only for the internal QA team (alpha builds) to provide logs
