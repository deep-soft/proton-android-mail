...
interface RsvpEventRepository {

    suspend fun identifyRsvp(userId: UserId, messageId: MessageId): Either<DataError, Boolean>

    suspend fun getRsvpEvent(userId: UserId, messageId: MessageId): Either<DataError, RsvpEvent>
