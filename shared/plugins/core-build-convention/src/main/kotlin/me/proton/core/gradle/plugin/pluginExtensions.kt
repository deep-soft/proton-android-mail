...
public open class DaggerExtension @Inject constructor() : DaggerConventionSettings {
    override var workManagerHiltIntegration: Boolean = DaggerDefaults.WORK_MANAGER_HILT_INTEGRATION
}
...
public open class AndroidLibraryExtension @Inject constructor(objects: ObjectFactory) :
    KotlinConventionSettings {
    override var apiMode: Property<ExplicitApiMode> =
        objects.property<ExplicitApiMode>().convention(KotlinDefaults.API_MODE)
}
...
public open class CommonConfigurationExtension @Inject constructor(objects: ObjectFactory) :
    ...
    public var compileSdk: Property<Int> =
        objects.property<Int>().convention(AndroidDefaults.COMPILE_SDK)
    public var jvmTarget: Property<JavaVersion> =
        objects.property<JavaVersion>().convention(JvmDefaults.JVM_TARGET)
    public var minSdk: Property<Int> = objects.property<Int>().convention(AndroidDefaults.MIN_SDK)
    public var ndkVersion: Property<String> =
        objects.property<String>().convention(AndroidDefaults.NDK_VERSION)
    public var targetSdk: Property<Int> =
        objects.property<Int>().convention(AndroidDefaults.TARGET_SDK)
    public var testInstrumentationRunner: Property<String> =
        objects.property<String>().convention(AndroidDefaults.TEST_INSTRUMENTATION_RUNNER)
}
