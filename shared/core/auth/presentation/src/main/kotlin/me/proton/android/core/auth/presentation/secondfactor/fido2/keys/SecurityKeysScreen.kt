...
fun SecurityKeysEmptyListHeader() {
    LearnMoreText(text = R.string.auth_fido_security_keys_empty_list)
...
fun SecurityKeysListHeader() {
    Text(
        text = stringResource(id = R.string.auth_fido_security_keys_registered),
...
@Composable
fun SecurityKeysListFooter(onManageSecurityKeysClicked: () -> Unit) {
    Spacer(modifier = Modifier.height(dimensionResource(id = R.dimen.gap_large_plus)))
    LearnMoreText(text = R.string.auth_fido_manage_security_keys_info)
    Spacer(modifier = Modifier.height(dimensionResource(id = R.dimen.gap_medium_plus)))
    ProtonSolidButton(
        contained = false,
        ...
        Text(text = stringResource(R.string.auth_fido_manage_security_keys))
    }
}

@Composable
fun SecurityKeysEmptyListFooter(onAddSecurityKeyClicked: () -> Unit) {
    ProtonSolidButton(
        contained = false,
        ...
        Row(
            ...
            Text(text = stringResource(R.string.auth_fido_add_security_key))
            Icon(
