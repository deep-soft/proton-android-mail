...
class HumanVerificationHelpScreenKtTest(
    config: DeviceConfig
) {
    @get:Rule
    ...
    @Test
    fun humanVerificationHelpScreenLight() {
        paparazzi.snapshot {
            HumanVerificationHelpScreenPreview()
        }
    }

    @Test
    fun humanVerificationHelpScreenDark() {
        paparazzi.snapshot {
            HumanVerificationHelpScreenDarkPreview()
        }
    }
