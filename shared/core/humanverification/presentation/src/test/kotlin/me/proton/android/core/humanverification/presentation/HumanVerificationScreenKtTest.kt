...
class HumanVerificationScreenKtTest(
    config: DeviceConfig
) {
    @get:Rule
    ...
    @Test
    fun humanVerificationLightScreen() {
        paparazzi.snapshot {
            HumanVerificationScreenPreview()
        }
    }

    @Test
    fun humanVerificationDarkScreen() {
        paparazzi.snapshot {
            HumanVerificationScreenDarkPreview()
        }
    }
