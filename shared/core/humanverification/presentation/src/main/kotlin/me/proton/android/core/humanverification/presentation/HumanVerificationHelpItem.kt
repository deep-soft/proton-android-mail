...
import me.proton.android.core.humanverification.presentation.R as CoreR

@Composable
fun HumanVerificationHelpItem(
...
internal fun HelpItemWithDescriptionPreview() {
    HumanVerificationHelpItem(
        icon = R.drawable.ic_proton_user_circle,
        title = CoreR.string.human_verification_request_invite_title,
        description = CoreR.string.human_verification_request_invite_description,
        onClick = {}
    )
}
...
internal fun HelpItemNoDescriptionPreview() {
    HumanVerificationHelpItem(
        icon = R.drawable.ic_proton_user_circle,
        title = CoreR.string.human_verification_request_invite_title,
        onClick = {}
...
internal fun HelpItemNoDescriptionDarkPreview() {
    HumanVerificationHelpItem(
        icon = R.drawable.ic_proton_user_circle,
        title = CoreR.string.human_verification_request_invite_title,
        description = CoreR.string.human_verification_request_invite_description,
