...
package me.proton.android.core.accountmanager.domain.usecase
...
class ObservePrimaryAccountAvatarItem @Inject constructor(
    private val getAccountAvatarItem: GetAccountAvatarItem,
    private val observePrimaryCoreAccount: ObservePrimaryCoreAccount
) {

    operator fun invoke(): Flow<CoreAccountAvatarItem?> =
        observePrimaryCoreAccount().map { getAccountAvatarItem(it?.userId) }
}
