...
internal class NotificationsPermissionOrchestratorImpl @Inject constructor(
    ...
    override fun requestPermissionIfRequired() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            rationalePermissionRequester?.launch(NotificationsPermissionOrchestrator.NOTIFICATION_PERMISSION)
        } else {
            navigateToSystemNotificationSettings()
        }
    }
        ...
        rationalePermissionRequester = caller.registerForActivityResult(
            ...
            if (
                ...
                !caller.shouldShowRequestPermissionRationale(
                    NotificationsPermissionOrchestrator.NOTIFICATION_PERMISSION
                )
            ) {
                navigateToSystemNotificationSettings()
            }
    ...
    private fun navigateToSystemNotificationSettings() {
