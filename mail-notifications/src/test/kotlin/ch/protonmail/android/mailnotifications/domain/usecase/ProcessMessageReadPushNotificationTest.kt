...
internal class ProcessMessageReadPushNotificationTest {
    ...
    private companion object {
        ...
        val NotificationData = LocalPushNotification.Message.MessageRead(
            LocalPushNotificationData.UserPushData(UserId, UserEmail),
            MessagePushData.MessageReadPushData(MessageId)
        )
