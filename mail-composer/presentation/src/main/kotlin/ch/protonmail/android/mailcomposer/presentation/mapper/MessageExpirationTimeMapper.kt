...
fun MessageExpirationTime.toUiModel() = when (this) {
    is MessageExpirationTime.Custom -> ExpirationTimeUiModel(ExpirationTimeOption.Custom, this.expiresAt)
    is MessageExpirationTime.Never -> ExpirationTimeUiModel(ExpirationTimeOption.None)
    is MessageExpirationTime.OneDay -> ExpirationTimeUiModel(ExpirationTimeOption.OneDay)
