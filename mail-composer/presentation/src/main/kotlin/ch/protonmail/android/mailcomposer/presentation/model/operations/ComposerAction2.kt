...
internal sealed interface ComposerAction2 : ComposerStateOperation {
    ...
    data object InlineImageActionsRequested : ComposerAction2
    data object AddAttachmentsRequested : ComposerAction2
    data object OpenPhotosPicker : ComposerAction2
    data object OpenCameraPicker : ComposerAction2
    data object OpenFilePicker : ComposerAction2
    data class AddAttachments(val uriList: List<Uri>) : ComposerAction2
    data class AddFileAttachments(val uriList: List<Uri>) : ComposerAction2
