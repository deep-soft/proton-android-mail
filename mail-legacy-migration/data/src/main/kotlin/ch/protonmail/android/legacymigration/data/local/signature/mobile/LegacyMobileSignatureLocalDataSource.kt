...
interface LegacyMobileSignatureLocalDataSource {

    suspend fun getMobileSignaturePreference(userId: UserId): Either<MigrationError, LegacyMobileSignaturePreference>
