...
class SetLegacyMigrationStatus @Inject constructor(
    private val repository: LegacyMigrationStatusRepository
) {

    suspend operator fun invoke(status: LegacyMigrationStatus) = repository.setMigrationStatus(status)
