...
class IsLegacyAutoLockEnabled @Inject constructor(
    private val legacyAutoLockRepository: LegacyAutoLockRepository
) {
    suspend operator fun invoke(): Boolean = legacyAutoLockRepository.autoLockEnabled().getOrNull()?.isEnabled ?: false
