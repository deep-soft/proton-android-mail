...
class ShouldMigrateAutoLockBiometricPreference @Inject constructor(
    private val legacyAutoLockRepository: LegacyAutoLockRepository
) {
    suspend operator fun invoke(): Boolean = legacyAutoLockRepository.hasAutoLockBiometricPreference()
