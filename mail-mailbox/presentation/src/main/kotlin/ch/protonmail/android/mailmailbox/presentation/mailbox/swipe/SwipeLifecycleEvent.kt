...
internal sealed interface SwipeLifecycleEvent {
    data class GestureStarted(val direction: SwipeToDismissBoxValue) : SwipeLifecycleEvent

    data class DirectionChanged(val direction: SwipeToDismissBoxValue) : SwipeLifecycleEvent
    ...
    data object SwipingDisabled : SwipeLifecycleEvent
}
