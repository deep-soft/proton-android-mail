...
class PrefetchRepositoryImpl @Inject constructor(
    private val prefetchDataSource: RustPrefetchDataSource
) : PrefetchRepository {

    override suspend fun prefetch(userSessionWrapper: MailUserSessionWrapper) {
        prefetchDataSource.prefetchData(userSessionWrapper.getRustUserSession())
    }
}
