...
package protonmail.android.mailpinlock.presentation.pin

import ch.protonmail.android.mailcommon.presentation.Effect
import ch.protonmail.android.mailcommon.presentation.model.TextUiModel
import ch.protonmail.android.mailpinlock.presentation.pin.AutoLockPinEvent
import ch.protonmail.android.mailpinlock.presentation.pin.AutoLockPinReducer
...
internal class AutoLockPinReducerTest(private val testInput: TestInput) {
    ...
    private companion object {
        ...
        val biometricPinUiMapper =
            AutoLockBiometricPinUiMapper()
        val biometricPromptUiMapper =
        ...
        fun data() = arrayOf(
                ...
                expected = AutoLockTestData.BaseLoadedState.copy(
                    pinInsertionState = AutoLockTestData.BasePinInsertionState.copy(
                        pinInsertionUiModel = PinInsertionUiModel(
                            AutoLockTestData.BaseValidPinInserted
                        )
                    ),
            ...
            TestInput(
                ...
                expected = AutoLockTestData.BaseLoadedState.copy(
                    pinInsertionState = AutoLockTestData.BasePinInsertionState.copy(
                        pinInsertionUiModel = PinInsertionUiModel(
                            AutoLockTestData.BaseInvalidPinInserted
                        )
                    ),
                    confirmButtonState = AutoLockTestData.BaseConfirmButtonState.copy(
