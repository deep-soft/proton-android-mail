...
import ch.protonmail.android.mailpinlock.presentation.autolock.AutoLockEnabledUiModel
import ch.protonmail.android.mailpinlock.presentation.autolock.AutoLockIntervalUiModel
import ch.protonmail.android.mailpinlock.presentation.autolock.AutoLockIntervalsUiModel
import ch.protonmail.android.mailpinlock.presentation.autolock.AutoLockSettingsEvent
import ch.protonmail.android.mailpinlock.presentation.autolock.AutoLockSettingsReducer
...
internal class AutoLockSettingsReducerTest(
    ...
    companion object {
        ...
        private val oneDayUiModel = AutoLockIntervalUiModel(
            AutoLockInterval.OneDay,
            description = 1
        )
        private val immediatelyUiModel = AutoLockIntervalUiModel(
        ...
        fun data() = arrayOf(
            ...
            TestInput(
                ...
                baseDataLoaded.copy(
                    autoLockEnabledState = baseAutoLockState.copy(
                        AutoLockEnabledUiModel(
                            false
                        )
                    )
                )
