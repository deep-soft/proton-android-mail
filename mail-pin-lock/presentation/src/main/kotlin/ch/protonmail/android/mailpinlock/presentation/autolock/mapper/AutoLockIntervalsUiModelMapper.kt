...
class AutoLockIntervalsUiModelMapper @Inject constructor() {
    ...
    fun toIntervalsListUiModel(): List<AutoLockIntervalUiModel> = AutoLockInterval.entries.map {
        AutoLockIntervalUiModel(
            it,
            it.getDescriptionStringRes()
        )
    }

    fun toSelectedIntervalUiModel(selectedInterval: AutoLockInterval) = AutoLockIntervalUiModel(
        selectedInterval,
        selectedInterval.getDescriptionStringRes()
    )
