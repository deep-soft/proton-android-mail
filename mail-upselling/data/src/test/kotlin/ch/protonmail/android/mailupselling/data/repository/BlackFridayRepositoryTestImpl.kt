...
internal class BlackFridayRepositoryTestImpl {

    private val dataSource = mockk<BlackFridayLocalDataSource>()

    private lateinit var repository: BlackFridayRepositoryImpl

    @BeforeTest
    fun setup() {
        repository = BlackFridayRepositoryImpl(dataSource)
    }
    ...
    fun `should proxy the observation to the datasource (success)`() = runTest {
        ...
        val expected = BlackFridaySeenPreference(phase, 0L)
