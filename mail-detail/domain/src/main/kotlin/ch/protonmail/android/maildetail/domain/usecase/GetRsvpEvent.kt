...
class GetRsvpEvent @Inject constructor(
    private val rsvpEventRepository: RsvpEventRepository
) {

    suspend operator fun invoke(userId: UserId, messageId: MessageId): Either<DataError, RsvpEvent> =
        rsvpEventRepository.getRsvpEvent(userId, messageId)
}
